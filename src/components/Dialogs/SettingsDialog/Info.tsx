...
const infoData: TInfoData = {
    ...
    DefaultAdditionalFee: {
        ...
        text: 'Fee will be added to all transactions generated in IDE via UI, tests or console. E.g.: you can set it to 400000. This way every new generated tx will be valid if it is sent from scripted account',
    }
};
